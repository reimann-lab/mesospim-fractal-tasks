from mesospim_fractal_tasks.tasks.correct_flatfield_parallel import correct_flatfield
from mesospim_fractal_tasks.tasks.init_correct_flatfield_parallel import init_correct_flatfield
...
if __name__ == "__main__":
    ...
    for element in parallel_list:
        ...
        param["n_zplanes"] = n_zplanes
        param["models_folder"] = models_folder
